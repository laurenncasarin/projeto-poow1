...
public class FilmeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (req.getParameter("id") == null) {
            ...
            List<Filme> melhoresfilmes = new FilmeService().listarMelhoresFilmes();
            req.setAttribute("melhoresfilmes", melhoresfilmes);
        }else {
        ...
        if (session != null && session.getAttribute("sessaousuario") != null) {
            if ("cadastrar".equals(page)) {
                ...
                rd.forward(req, resp);
            } else if ("minhas".equals(page)) {
                RequestDispatcher rd = req.getRequestDispatcher("WEB-INF/pages/minhasavaliacoes.jsp");
                rd.forward(req, resp);
