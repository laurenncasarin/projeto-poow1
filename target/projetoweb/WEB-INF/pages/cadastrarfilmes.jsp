...
<nav class="navbar navbar-expand-lg navbar-custom">
    <div class="container-fluid">
        <img src="imgs/logodisco.png" href="filmes?page=dash" alt="Logo" width="80" height="80" class="d-inline-block align-text-top">
...
<h1 class="text-center mt-4" style="color: #8B0000;">Cadastrar Filmes</h1>
